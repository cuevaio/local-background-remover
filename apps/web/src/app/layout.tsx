    ...
    >
      <body>
        ...
        <div className="sticky top-0 z-50 border-b border-border bg-black text-white">
          <ExpLink
            href="/pricing"
            className="block focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/70 focus-visible:ring-offset-2 focus-visible:ring-offset-black"
          >
