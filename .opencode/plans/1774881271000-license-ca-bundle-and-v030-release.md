# Plan: Harden license TLS and prepare `v0.3.2`

## Goal
- Ensure CLI license API calls work reliably in packaged binaries by loading trusted CA bundles.
- Ship the release as `v0.3.2` with aligned package/version metadata.
...
5. Bump CLI versioned files from `0.2.0` to `0.3.2`.
